...
public struct TLPhotosPickerConfigure {
    ...
    public var previewAtForceTouch = true
    ...
    public var selectedColor = UIColor(rgb: 0x5E5CF5) // UIColor(red: 88/255, green: 144/255, blue: 255/255, alpha: 1.0)
...
extension TLPhotosPickerViewController {
    ...
    @objc open func makeUI() {
        ...
        self.cancelButton.tintColor = self.configure.selectedColor
        ...
        self.doneButton.tintColor = self.configure.selectedColor
